...
import { RootState } from "@/app/store"; // Adjust the path if needed
...
interface AppContextType {
  ...
  board: any; // Replace 'any' with the correct board type
  hideSide: boolean;
...
function AppContextProvider({ children }: AppContextProviderProps): React.JSX.Element {
  ...
  const board = boards.find((item) => item.name === selected) || null; // Prevents undefined issues
