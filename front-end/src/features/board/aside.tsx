...
// import { ReactComponent as MyIcon } from '../../../public/assets/';

interface AsideProps {
    setSelectBord?: React.Dispatch<React.SetStateAction<boolean>>;
    erre?: React.RefObject<HTMLFormElement | null>; // Ensure proper typing for `form`
}


const Aside: React.FC<AsideProps> = ({ erre, setSelectBord }) => {
