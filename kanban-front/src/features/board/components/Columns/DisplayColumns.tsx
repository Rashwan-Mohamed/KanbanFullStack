            ...
            <DndMainContext>
                {columns.map((item, index) => {
                    ...
                    return (
                        ...
                        <DroppableColumn key={id ?? index} id={id ?? index}>
                            <SortableColumnContext tasks={tasks?.map((task) => task.id) ?? []}
                                                   id={id ?? index}>
                            <span>
                ...
                <p>
                  {name} ({tasks?.length})
                                ...
                                <ul className={`${!tasks?.length ? 'emptyColumn' : 'undefined'}`}>
                                    ...
                                    {/*{tasks?.length == 0 && <SortableTaskTest id={id}></SortableTaskTest>}*/}
                                </ul>
